...
/**
 * Bean definitions for {@link ReservaRepository}.
 */
@Generated
public class ReservaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'reservaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getReservaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'reservaRepository'.
   */
  public static BeanDefinition getReservaRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ReservaRepository.class, ReservaVehiculo.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.fleetops.vehicles.repositories.ReservaRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ReservaRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.fleetops.vehicles.repositories.ReservaRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getReservaRepositoryInstanceSupplier();
