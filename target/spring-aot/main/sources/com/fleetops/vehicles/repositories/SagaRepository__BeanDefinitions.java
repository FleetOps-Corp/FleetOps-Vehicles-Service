...
/**
 * Bean definitions for {@link SagaRepository}.
 */
@Generated
public class SagaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'sagaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getSagaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'sagaRepository'.
   */
  public static BeanDefinition getSagaRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, SagaRepository.class, SagaVehiculo.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.fleetops.vehicles.repositories.SagaRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.SagaRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.fleetops.vehicles.repositories.SagaRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getSagaRepositoryInstanceSupplier();
