...
/**
 * Bean definitions for {@link VehicleRepository}.
 */
@Generated
public class VehicleRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'vehicleRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getVehicleRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'vehicleRepository'.
   */
  public static BeanDefinition getVehicleRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, VehicleRepository.class, Vehiculo.class, UUID.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.fleetops.vehicles.repositories.VehicleRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.VehicleRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.fleetops.vehicles.repositories.VehicleRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getVehicleRepositoryInstanceSupplier();
