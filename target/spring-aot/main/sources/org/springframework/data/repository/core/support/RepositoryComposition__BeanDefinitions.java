...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.ReservaRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.SagaRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.HistorialEstadoRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.TipoVehiculoRepository.fragments#0'.
     */
