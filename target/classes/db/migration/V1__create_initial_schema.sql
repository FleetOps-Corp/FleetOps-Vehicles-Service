...
CREATE TABLE vehiculos (
    ...
    estado_vehiculo    VARCHAR(20)  DEFAULT 'DISPONIBLE',
...
CREATE TABLE reservas_vehiculo (
    ...
    id_vehiculo         UUID         NOT NULL,
    id_saga             UUID NOT NULL UNIQUE,
    id_asignacion_ext   UUID NOT NULL UNIQUE,        -- Llave lógica de correlación con microservicios satélites
